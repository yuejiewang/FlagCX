...
typedef struct {
  ...
  flagcxResult_t (*connect)(int dev, flagcxNetCommConfig_v10_t* config, void* handle, void** sendComm, flagcxNetDeviceHandle_v10_t** sendDevComm);
  ...
  flagcxResult_t (*accept)(void* listenComm, void** recvComm, flagcxNetDeviceHandle_v10_t** recvDevComm);
...
typedef struct {
  ...
  // May return request == NULL if the call cannot be performed (or would block).
  flagcxResult_t (*iallreduce)(void* collComm, void* sendData, void* recvData, size_t count,
      flagcxDataType_t dataType, flagcxRedOp_t redOp, void* sendMhandle, void* recvMhandle, void** request);
  flagcxResult_t (*iallgather)(void* collComm, void* sendData, int nRecvParts, flagcxNetSGE_v10_t* recvParts,
                             size_t bytesPerRank, size_t windowOffset, size_t windowBytes,
                             void* sendMhandle, void** request);
  flagcxResult_t (*ireducescatter)(void* collComm, int nSendParts, flagcxNetSGE_v10_t* sendParts, void* recvData,
                                 size_t bytesPerRank, size_t windowOffset, size_t windowBytes,
...
typedef struct {
  ...
  // it will be called again until sendComm != NULL.
  // If *sendDevComm points to a valid object, then flagcx is requesting device offload for this connection
  flagcxResult_t (*connect)(int dev, void* handle, void** sendComm, flagcxNetDeviceHandle_v9_t** sendDevComm);
  // Finalize connection establishment after remote peer has called connect.
  // This call must not block for the connection to be established, and instead
  // should return successfully with recvComm == NULL with the expectation that
  // it will be called again until recvComm != NULL.
  // If *recvDevComm points to a valid object, then flagcx is requesting device offload for this connection
  flagcxResult_t (*accept)(void* listenComm, void** recvComm, flagcxNetDeviceHandle_v9_t** recvDevComm);
  // Register/Deregister memory. Comm can be either a sendComm or a recvComm.
  // Type is either FLAGCX_PTR_HOST or FLAGCX_PTR_CUDA.
  flagcxResult_t (*regMr)(void* comm, void* data, size_t size, int type, void** mhandle);
  /* DMA-BUF support */
...
typedef struct {
  ...
  flagcxResult_t (*iallreduce)(void* collComm, void* sendData, void* recvData, size_t count,
      flagcxDataType_t dataType, flagcxRedOp_t redOp, void* sendMhandle, void* recvMhandle, void** request);
  flagcxResult_t (*iallgather)(void* collComm, void* sendData, int nRecvParts, flagcxNetSGE_v9_t* recvParts,
                             size_t bytesPerRank, size_t windowOffset, size_t windowBytes,
                             void* sendMhandle, void** request);
  flagcxResult_t (*ireducescatter)(void* collComm, int nSendParts, flagcxNetSGE_v9_t* sendParts, void* recvData,
                                 size_t bytesPerRank, size_t windowOffset, size_t windowBytes,
                                 flagcxDataType_t dataType, flagcxRedOp_t redOp,
                                 void* recvMhandle, void** request);
  // Perform a flush/fence to make sure all data received with flagcx_PTR_CUDA is
